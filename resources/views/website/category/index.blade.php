                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a href="{{route('product.by.subcategory',$subcategory->id)}}">{{$subcategory->name}}</a><span>({{totalProductBySubcatId($subcategory->id)}})</span>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="single-widget condition">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="check{{$key+1}}">
                                <label class="form-check-label" for="check{{$key+1}}">
                                    {{$brand->name}}({{totalProductByBrandId($brand->id)}})
                                </label>
                            </div>
                            @endforeach
                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{asset($product->feature_image)}}" style="height: 200px;width: 100%">
                                                <div class="button">
